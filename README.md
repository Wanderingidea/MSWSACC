...
### Purpose:
Generates Gigabytes of random numbers in minutes with 8 (pref. true, non-deterministic) random bytes as seed input.<br>
...
https://github.com/Wanderingidea/CH552TRNG<br>
